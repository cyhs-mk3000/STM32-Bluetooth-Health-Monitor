...
{
	MPU6050_IIC_START();
	MPU6050_IIC_SEND_BYTE(MPU6050_SLAVE_ADDRESS);
	MPU6050_IIC_WAIT_ACK();
	MPU6050_IIC_SEND_BYTE(reg_add);
	MPU6050_IIC_WAIT_ACK();
	MPU6050_IIC_SEND_BYTE(reg_dat);
	MPU6050_IIC_WAIT_ACK();
	MPU6050_IIC_STOP();
}
...
void MPU6050_ReadData(u8 reg_add,unsigned char*Read,u8 num)
{
	...
	MPU6050_IIC_START();
	MPU6050_IIC_SEND_BYTE(MPU6050_SLAVE_ADDRESS+1);
	MPU6050_IIC_WAIT_ACK();
	
	for(i=0;i<(num-1);i++){
		*Read=MPU6050_IIC_READ_BYTE(1);
		Read++;
	}
	*Read=MPU6050_IIC_READ_BYTE(0);
	MPU6050_IIC_STOP();
}
